    ...
    <div class="flex-1 py-2 px-2 flex flex-col h-full md:px-5">
        <div class="px-2 flex flex-col w-full justify-center content-center items-center sm:flex-row">
            <div class="w-full lg:ml-3">
                <h1 class="text-left uppercase text-sm pt-1 lg:text-base line-clamp-2 md:py-4">{{ $producto->nombre }}</h1>
            ...
            <div class="w-full">
                <p class="text-left text-xs md:py-4 md:text-base">
                    <i class="fas fa-cubes text-xs md:text-lg lg:text-xl"></i> Categoria: {{ $producto->categoria->nombre }}
                </p>
                <p class="text-left text-xs md:py-4 md:text-base">
                    <i class="fas fa-store text-xs md:text-lg lg:text-xl"></i> Publicado por: {{ $producto->tienda->nombre }}
                </p>
            </div>
        </div>
    </div>
