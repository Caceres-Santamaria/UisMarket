<footer
    class="grid-in-footer grid grid-cols-1 grid-areas-foot gap-4 bg-black  pt-4 text-white place-items-center place-content-start">
    <div class="grid-in-descripcion">
        <h2 class="font-Delius text-lg font-semibold tracking-wide m-0 lg:text-xl md:text-xl">Incentivando el
            emprendimiento uis</h2>
    </div>
    <div class="grid-in-nosotros ">
        ...
        <p class="m-0 lg:text-sm md:text-sm text-center	block text-xs"><a class="no-underline"
                href="{{ route('politicas') }}">Política de privacidad</a></p>
    </div>
