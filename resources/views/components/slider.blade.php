                                ...
                                <li class="splide__slide">
                                    <div class=" card-producto border-gray-200 border-2 rounded-md p-1">
                                        <a href="{{ route('tiendas.show', $tienda) }}"
                                            ...
                                            @else
                                                <div
                                                    class="flex justify-center items-center w-full h-full" style="background-color:rgb(186, 189, 194)">
                                                    <svg class="h-20 w-20 bg-white rounded-full" xmlns="http://www.w3.org/2000/svg"
                                                        viewBox="0 0 24 24"
