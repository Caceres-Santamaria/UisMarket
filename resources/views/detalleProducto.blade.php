...
@endsection
@section('contenido')
    <main class="grid-in-contenido grid grid-cols-full grid-rows-detalle px-10 py-6 place-items-start place-content-start md:grid-rows-auto md:grid-cols-5050 md:p-2 md:py-10 lg:grid-rows-auto lg:grid-cols-5050 lg:px-10 lg:py-16">
                    ...
                    <div class="splide__track splide__track--primary flex justify-center">
                        <ul class="splide__list">
                                <li class="splide__slide p-splide__slide cursor-pointer ">
                                    <img class="card-producto__img w-60 md:w-72 lg:w-80" src="{{asset('storage/images/website/p1.jpg')}}">
                                </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="detalle-producto grid w-full grid-cols-full grid-rows-5auto grid-areas-detalle gap-2.5 px-0 py-6 md:pt-0 md:px-0.5 md:pb-6 lg:pt-0 lg:px-0.5 lg:pb-6">
            <h1 class="titulo-producto grid-in-titulo text-2xl font-bold m-0 lg:m-0">producto</h1>
            <div class="Precio-stock-producto grid-in-precio flex justify-between items-center border-b border-primario-light">
                <div>
            ...
            <div class="tallas-producto grid-in-tallas">
                <form method="post" action="" >
                    ...
                    <br/>
                    <div class="">
                        <p class="no-stock hidden p-2 border border-red-500 w-60 text-red-500 cursor-not-allowed " id="no-stock"><i class="fas fa-exclamation-circle mr-1"></i>Prenda No Disponible</p>
                        <div class="cantidad-agregar flex items-center justify-start pt-5 pb-2.5 ">
                            ...
                            <button type="submit" id="shopify_add_to_cart" class="agregar-carrito bg-primario-n text-white h-10 rounded-lg text-center leading-10 border-0 cursor-pointer px-4 py-0 hover:bg-primario-ligth">
