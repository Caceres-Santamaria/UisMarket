<x-app2-layout title="Detalle Producto">
    ...
    <main
        ...
        <div
            class=" grid w-full grid-cols-full grid-rows-5auto grid-areas-detalle gap-2.5 px-5 py-6 md:pt-0 md:px-0.5 md:pb-6 lg:pt-0 lg:px-0.5 lg:pb-6 lg:pr-16">
            <h1 class=" grid-in-titulo text-2xl font-bold m-0 lg:m-0">producto</h1>
            <div
                class="grid-in-precio flex justify-between items-center border-b border-primario-light">
                <div>
                    <p class=" m-0 p-2 text-xl ">$100.000</p>
                </div>
                <div class=" text-lg " id="producto-stock"></div>
            </div>
            <div class=" grid-in-descripcion text-base px-0 py-2.5 font-medium">
            ...
            <div class=" grid-in-tallas">
                <form method="post" action="">
                    ...
                    <br />
                    <div class="">
                        <p class=" hidden p-2 border border-red-500 w-60 text-red-500 cursor-not-allowed "
                            id=""><i class="fas fa-exclamation-circle mr-1"></i>Prenda No Disponible</p>
                        <div class=" flex items-center justify-start pt-5 pb-2.5 ">
                            <div class=" relative flex items-center w-24 h-10 border-gray-500 border-l "
                                id="">
                                <div
