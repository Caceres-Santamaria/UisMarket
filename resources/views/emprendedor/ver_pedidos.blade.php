        ...
        <div class="bg-white rounded-lg shadow-lg px-6 py-4 mb-6 flex items-center">
            ...
            @if ($pedido->estado == 1)
                <div class="ml-auto flex flex-col md:flex-row items-center justify-between gap-2">
                    <form action="{{ route('emprendedor.pedidos.updateConfirmacion', $pedido->id) }}" method="post" x-data
            ...
            @elseif($pedido->estado == 2)
                <form action="{{ route('emprendedor.pedidos.update', $pedido->id) }}" class="ml-auto" method="post" x-data
