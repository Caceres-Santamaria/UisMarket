...
<main class="grid-in-contenido my-6 mx-8 text-sm text-justify lg:text-base lg:my-14 lg:mx-28">
  ...
  <h1 class="flex justify-center font-semibold text-xl lg:text-3xl mb-4">¿Quiénes somos?</h1>

  <p> <img class="w-48 sm:w-80 lg:w-96 float-right ml-6" src="{{asset('storage/images/website/about.jpg')}}" alt=""> UIS market es una iniciativa de estudiantes UIS para promover la compra de productos locales y así incentivar 
  ...
  <h2 class="flex justify-left font-semibold text-lg lg:text-2xl mb-4 mt-6">¿Quieres ser parte de UIS market?</h2>
